...
| Level | Icon | Value |
|------|------|-------|
| Overall Coverage Score | 🟡 | 50.00% |
| SCM-006 Coverage Score | 🟢 | 60.00% |
| SCM-007 Coverage Score | 🟠 | 40.00% |
...
| SCM-007 | AC5 | No testcase explicitly validates that compliance team approval is required for subscription transfers involving billing entity or tax jurisdiction change. | Partially Covered |
