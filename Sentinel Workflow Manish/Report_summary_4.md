...
These user stories form the baseline for evaluation, limited to unit test coverage and execution records mapped to the identified user stories.
...
| SCM-004 | AC5 | No testcase explicitly validates that finance team approval is required before the cancellation is processed. | Partially Covered |
