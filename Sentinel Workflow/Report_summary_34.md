...
| ORM-001 | AC4 | No testcase explicitly validates customer ID capture in refund audit logs. | Not Covered |
| ORM-001 | AC4 | No testcase explicitly validates refund amount capture in refund audit logs. | Not Covered |
| ORM-001 | AC4 | No testcase explicitly validates approval timestamp capture in refund audit logs. | Not Covered |
...
The user story ORM-001 is Not Covered, therefore remediation is required before progression.
