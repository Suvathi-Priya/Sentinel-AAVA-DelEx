...
| SCM-005 | AC5 | No testcase explicitly validates subscriptions with annual value greater than $10,000.; No testcase explicitly validates reminder sending to the customer for high-value subscriptions.; No testcase explicitly validates reminder sending to the assigned account manager for high-value subscriptions. | Not Covered |
| SCM-006 | AC2 | No testcase explicitly validates adjusted billing amount in the notification. | Partially Covered |
...
| TP_SCM8_014 | missing_testlog | Execution log is missing for testcase ID: TP_SCM8_014 | SCM-008 | NULL | Medium |
| TP_SCM8_015 | missing_testlog | Execution log is missing for testcase ID: TP_SCM8_015 | SCM-008 | NULL | Medium |
